    ...
    <section className="flex min-h-screen w-full items-start justify-center bg-[#f8f9fa] px-4 py-8 sm:px-6 md:px-10">
      <div className="w-full max-w-[880px]">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-[#52796f]">SME Verification Wizard</p>
            <h1 className="text-2xl font-bold text-[#1b4332] sm:text-3xl">
              Submit product proof
            </h1>
          </div>
          <button
            type="button"
        ...
        >
          <div className="mb-8 rounded-xl bg-[#f4f7f5] p-4 text-sm text-[#315948]">
            Step 2 of 2. This core action screen focuses on the product claim, evidence upload, and explicit consent before badge generation.
          </div>
          ...
          <label className="mt-8 flex items-start gap-3 rounded-lg bg-[#f4f7f5] px-4 py-4 text-sm text-[#315948]">
            ...
            />
            <span>I confirm the uploaded documents can be used for verification.</span>
          </label>
